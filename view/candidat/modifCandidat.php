             ...
             <div class="card">
                ...
                <div class="card-body">
                      ...
                      <div class="form-group">
                             ...
                             <input name="id_candidat" readonly="readonly" type="text" class="form-control" value="<?php echo $_GET['id_candidat'] ?>">
                          </div>    
                      <div class="form-group">
                          ...
                          <div class="form-group mt-3">
                             ...
                             <input name="photo_partie" type="text" class="form-control" required placeholder="photo du Partie">
                          </div>
                          <div class="form-group mt-3">
